...
SetFinalOutput(file="K_half_kmm_biased_q2.g2")
...
q     = 3        # orden = polynomial degree of basis functions + 1
b1    = 0.9      # bias factor
b2    = 0.9      # bias factor
b3    = 0.9      # bias factor
n1    = 3       # # of new knots
...
#	UniformVolume(vol[4], 1, 2)
#	UniformVolume(vol[5], 1, 2)
#	UniformVolume(vol[8], 3, 2)
