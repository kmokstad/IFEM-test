...
def MakePipes(theta, theta0):
  ...
  circ0_in = NonRationalCurve(circ0_in)
  circ1_in = NonRationalCurve(circ1_in)
  circ2_in = NonRationalCurve(circ2_in)
  circ3_in = NonRationalCurve(circ3_in)
  circ4_in = NonRationalCurve(circ4_in)
  circ5_in = NonRationalCurve(circ5_in)

  circ0_out = NonRationalCurve(circ0_out)
  circ1_out = NonRationalCurve(circ1_out)
  circ2_out = NonRationalCurve(circ2_out)
  circ3_out = NonRationalCurve(circ3_out)
  circ4_out = NonRationalCurve(circ4_out)
  circ5_out = NonRationalCurve(circ5_out)
