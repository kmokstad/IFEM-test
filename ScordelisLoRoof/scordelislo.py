...
# Create a NURBS surface (2x2 quadratic elements)
...
# Create a spline surface with 4x4 quadratic elements (18 Oct 2022)
surf = ScordelisLo(25,50).rebuild(p=(3,3),n=(6,6)).reparam()
with G2('scordelis-lo-s2-4x4.g2') as output:
    output.write(surf)
