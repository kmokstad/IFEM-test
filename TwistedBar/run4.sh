...
#         -UL - Updated Lagrangian formulation using material version 11
...
runNonlinel TBar4-p2-h7x28.inp -UL -MX 1 -nGauss 3 -vtf 1 -saveInc 0.1

runNonlinel TBar4-p2-h15x60.inp -UL -MX 1 -nGauss 3 -vtf 1 -saveInc 0.1

runNonlinel TBar4-p1-h16x64.inp -UL -MX 0 -nGauss 2 -vtf 1 -saveInc 0.1
